...
const PIECES = [
  ...
  ['Buttons and links', 'The quiet, the dangerous and the done', '05-buttons.html', 'The tray, the danger pair and the inert pill',
  ...
  ['Buttons and links', 'The yellow button', '05-buttons.html', 'The yellow verb, on the felt',
  ...
  ['Fields and choosers', 'A text field', '06-fields.html', 'The field',
  ...
  ['Fields and choosers', 'The settings tabs', '06-fields.html', 'The settings tabs',
    'The same tray one size up, across the top of the settings box.'],
  ['Fields and choosers', 'The games bar', '06-fields.html', 'The games bar',
  ...
  ['The small marks', 'The checkbox', '07-chips.html', 'The checkbox',
    'A box you can tick, the height of a small button, with its number after it. Picked, it turns green and shows the tick.'],
  ...
  ['Lines and dividers', 'A divider in three places', '03-shape.html', 'Dividers',
    'Where a line parts two regions of one colour: a chooser in a dialog, the rows of a leaderboard card, and the footer above its legal line. The line between two rows of one colour is the lighter hairline, the line on the band and the canvas is the band\u2019s rung, and a chooser draws its own. None of them is the line a box is drawn with.'],
  ...
  ['Lines and dividers', 'The line a box is drawn with', '03-shape.html', 'Rings: the inset 1px edge',
    'The edge that draws a container, laid inside its own box. It is a border, not a divider, and it is never the line used between rows.'],
  ...
  ['Lines and dividers', 'The line over tile art', '03-shape.html', 'The edge over tile art',
    'A picture takes a darkened rim rather than the page\u2019s own edge, so its line reads on any art under it.'],
  ...
  ['The chrome', 'The notices', '11-panels.html', 'The notices on the lobby and on the felt',
    'The toast and the corner notices, on paper and over the felt, including the shutdown warning that turns red.'],
